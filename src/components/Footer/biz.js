...
const Footer = () => {
  ...
  return (
    <FooterContainer>
      <div style={{ backgroundColor: "#fff", justifyContent: "center", alignItems: "center", width: "100%" }}>
        <WaitlistContainer>
        </WaitlistContainer>
        <BackedByContainer style={{ backgroundColor: "#fff", justifyContent: "center", alignItems: "center", margin: "auto", color: "#000", width: "100%" }}>
